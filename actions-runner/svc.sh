...
SVC_NAME="actions.runner.NikolayN-ru-gihubaction-react.MacBook-Pro-Nikolay"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (NikolayN-ru-gihubaction-react.MacBook-Pro-Nikolay)"
